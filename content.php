...
<div class="col-sm-6 col-lg-4">
	<article class="post <?php echo get_post_format(); ?>">
		...
		<p class="post-meta"><?php _e('By', 'bootplate'); ?> <?php the_author_posts_link(); ?> <?php _e('posted', 'bootplate'); ?> <?php the_time( get_option( 'date_format' ) ); ?> <?php _e('in', 'bootplate'); ?> <?php the_category(', '); ?></p>
	</article>
</div>
<?php endwhile; ?>
